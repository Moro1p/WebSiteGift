...
function loadCarouselContent() {
  ...
  const testPhotos = [
    ...
    { src: './assets/photos/photo4.jpg', comment: 'Наши поездки друг к другу на дачу. Прогулки по Калязину и окрестностям, встреча с твоей родней остались в тёплых воспоминаниях' },
    ...
    { src: './assets/photos/photo8.jfif', comment: 'А так никаких намеков или чего то такого) Просто теплые воспоминания, надеюсь не только для меня.' },
  ];
